  ...
  */
  ...
  onPlayPress = () => {
    ...
    if(this.props.voicetotext === false){
      // open pop up to create text order
...
*/}
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <Text style={{marginLeft:5, marginRight:5, marginTop: 5}}>VOICE ORDER</Text>
        ...
        {/* <Button title="Play" onPress={() => this.onPlayPress()}></Button>
        <Button title="Pause" onPress={() => this.onPausePress()}></Button> */}
