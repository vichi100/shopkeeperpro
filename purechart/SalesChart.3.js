...
export default class SalesChart extends React.Component { 
  ...
  switchTopCustomer = (val) =>{
     ...
     if(val === 2){
      this.setState({ activeSwitch: val, hBarData: this.state.monthlyTopCustomer  })
     }else if(val === 1){
      this.setState({ activeSwitch: val, hBarData: this.state.dailyTopCustomer  })
     }
  ...
  render () {
    ...
    // type = bar , pie, line
    return (
<View style={{ flex: 1, backgroundColor: '#FFFFFF', justifyContent: 'center', padding: 5, marginTop:10 }}>
      <ScrollView>
        ...
        <Text style={{ fontFamily: 'sans-serif', fontWeight:'500', }}>Top 15 buyer of the day</Text>
            ...
            <SwitchButton
                ...
                text2 = 'Monthly'                       // optional: second text in switch button --- default OFF
                switchWidth = {130}                 // optional: switch width --- default 44
                ...
                switchBorderRadius = {130}          // optional: switch border radius --- default oval
