...
class LineChart extends React.Component {
  ...
  drawCoordinate (index, start, end, backgroundColor, lineStyle, isBlank, lastCoordinate, seriesIndex) {
    ...
    return (
      <View key={key} style={{
        height: this.props.height + topMargin+5,
              ...
              return (
                <View key={series.seriesName}>
                  ...
                  <View style={{flexDirection: 'row', paddingLeft: 5, alignItems: 'center'}}>
                    ...
                    <Text style={styles.tooltipValue}>{numberWithCommas(dataObject.y+'/'+dataObject.z, false)}</Text>
                  </View>
                </View>
              )
            })}
  ...
  render () {
    ...
    console.log('this.state.sortedData: '+JSON.stringify(this.state.sortedData))
    return (
                  ...
                  {this.state.sortedData.map((obj, index) => {
                    return (
                      <Animated.View key={'animated_' + index} style={{
                        ...
                        minWidth: 200,
                        // Bottom Margin: vichi   marginBottom: this.props.minValue && this.state.guideArray && this.state.guideArray.length > 0 ? -1 * this.state.guideArray[0][2] * this.props.minValue : null
                        marginBottom: 10, //vichi
                      }} >
...
const styles = StyleSheet.create({
  ...
  tooltipValue: {fontWeight: 'bold', fontSize: 15, fontFamily: 'sans-serif',}
})
