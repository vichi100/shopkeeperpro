...
*/
  ...
  */
  ...
  render() {
    ...
    //       <Text style={{fontFamily:"sans-serif", marginTop:5, fontSize: 10,}}>OR TO CREATE NEW ORDERS AND SHARE GO TO CUSTOMERS</Text> 
        ...
        :<FlatList
          ...
          renderItem={({ item, index }) => (
            <View style={styles.container}>
              ...
              !(item.paymentstatus === "credit" || item.paymentstatus === 'received') &&
              item.iscancel === "no" ? (
                <TouchableOpacity
                ...
                >
                  ...
                  {item.iscancel === "no" ? (
                    ...
                    >
                      ...
                      {item.deliverystatus === "packed" || item.deliverystatus === "ofd" 
                      || item.deliverystatus === "completed" || item.paymentstatus == 'credit' 
                      || item.paymentstatus === 'received'? (
                        <CheckBox
                          title="Packed"
                          center
                    ...
                    {item.deliverystatus === 'ofd' || item.deliverystatus === 'completed' || item.paymentstatus == 'credit' 
                      || item.paymentstatus === 'received'?
                    <CheckBox
