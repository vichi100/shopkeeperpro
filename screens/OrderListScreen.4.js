...
class ExpandableItemComponent extends Component {
  ...
  itemSelected = (item) => {
    ...
    this.props.item.products.push(item)  
    ...
    return (
      <View>
        ...
        >
          ...
          onOpen = {this.itemSelected('vichi')}
				/>
          ...
          <View style={{flexDirection:'row', flex: 1}}>
                ...
                <TouchableHighlight
								...
								onPress={() => this.itemSelected(item.productid)}
							>
								<View style={styles.contentChecked}>
                  {this.state.indexChecked.includes(item.productid) ? <Text style={styles.alignCenter}>kyo</Text> 
                  : <Text style={styles.strikeText}>khi</Text>}
								</View>
							</TouchableHighlight>
...
export default class OrderListScreen extends Component { 
  ...
  updateDummyState = () =>{
    ...
    const array = [...this.state.listDataSource];
    array[1]["isExpanded"] = !array[1]["isExpanded"];
    this.setState(() => {
      return {
        listDataSource: array
      };
