                ...
                >
                  ...
                  {item.products.map((itemx, key) => (
                    <Swipeable
                      ...
                      leftButtonWidth="30"
                      rightButtonWidth="30"
                      onLeftButtonsOpenRelease={() => this.itemNotAvailbale(item, itemx)}
                      onLeftButtonsCloseRelease={() => this.itemIsAvailbale(item, itemx)}
...
{itemx.available === 'NA'? <Text style={styles.strikeText}>
                        ...
                        {itemx.available === 'NA'? <Text style={styles.text}>{itemx.qty}qty</Text> 
                        : <Text style={styles.text}>{itemx.qty}qty</Text>}
                        
                        {itemx.available === 'NA'? <Text style={styles.text}>{itemx.weight}g</Text>:
                        <Text style={styles.text}>{itemx.weight}g</Text>}
                        
                        {itemx.available === 'NA'?<Text style={styles.text}>{itemx.price}Rs</Text>: 
