...
*/
  ...
  */
  ...
  render() {
      ...
      <View style={{flex:1, justifyContent:'center', alignItems: 'center'}}>
        <TouchableOpacity onPress={() => this.registerShop()}>
              <View style={styles.buttonx}>
                <Text style={{color: "white",fontSize: 12, fontWeight:'500', fontFamily:"sans-serif"}}>REGISTER NOW</Text>
              </View>
              <Text style={{fontFamily:"sans-serif", marginTop:5, fontSize: 10,}}>TO CHECK YOUR CREDITORS AND CREDIT AMOUNT</Text> 
    ...
    if((this.state.listDataSource === null || this.state.listDataSource.length === 0) && !this.state.isFilterActive && !this.state.isSearching){
      return (
      <View style={{flex:1, justifyContent:'center', alignItems: 'center'}}>
    ...
    return (
      <View style={styles.container}>
        ...
        {((this.state.listDataSource === null || this.state.listDataSource.length === 0) && this.state.isFilterActive)?
        <View style={{flex:1, justifyContent:'center', alignItems: 'center'}}>
          ...
          renderItem={({ item, index }) => (
            <View style={styles.container}>
              {/*Code for Single Collapsible Start*/}
                ...
                <TouchableOpacity
                  onPress={() => this.toggleExpanded(item._id.customerid)}
                  onLongPress={() => this.showCancelOrderDialog(item._id.customerid)}
                  delayLongPress={1000}
                >
                  <View style={{ backgroundColor: "rgba(245, 54, 29, 0.198)", padding: 16}}>
                    <View
                      style={{
                        flex: 1,
                        flexDirection: "row",
                    ...
                    >
                      <Text style={styles.headerText}>{item._id.customername}</Text>
                      <View style={{ flexDirection: "row" }}>
              ...
              <Collapsible
                collapsed={
                  !(activeSections && activeSections.includes(item._id.customerid))
                }
                align="center"
              >
                <View
